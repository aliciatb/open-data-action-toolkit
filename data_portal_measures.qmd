...
In addition to evaluating how individual data assets are used, analysis of data portal features and data catalogs makes it possible to characterize a municipality's commitment to open data [@nahon2015], the impact of policy, governance, and population characteristics on [@wilson2020], levels of user engagement with open data portals [@begany2021], and the usefulness open data to the public and support for democratic participation [@schwoerer2022].

## Web Analytic Measures

Data portals typically provide the number of views of assets, downloads of datasets, and programmatic requests to the API (application programming interface) endpoints of assets to measure their utilization.

Measures of municipality commitment to open data include publishing frequency, coverage of data to  services provided, metadata completion, and communication mechanisms [@nahon2015].

User engagement with open data portals can be measured by activities including the creation of assets from datasets, views of assets, data downloads, and views of applications realized through API requests [@begany2021].
