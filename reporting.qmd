...
Since 2018, they have published annual reports [@cityofbatonrougeandparishofeastbatonrouge], which are often published directly on their open data platform, such as the most recent 2025 Open Data Policy Report [@cityofbatonrougeandparishofeastbatonrouge2025a].

## Blogs

Other ways of sharing information about initiatives powered by open data include blog posts. In San Francisco, the first Chief Data Officer explained the strategic vision of the program [@bonaguro2014] , initiated by the updated open data policy [@cityandcountyofsanfrancisco2013], and the progress made to institutionalize data practices provided by the current Chief Data Officer [@team2026].

Civic technology and advocacy organizations in Austin have published advocacy agendas [@openaustin2016] and contributions through new data, analysis, and advocacy [@carey2020; @carey2016; @rosenthal2013; @openaustin].
